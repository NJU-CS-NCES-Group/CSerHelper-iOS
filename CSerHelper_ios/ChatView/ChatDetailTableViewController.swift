...
class ChatDetailTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ChatDetailViewCell", for: indexPath) as? ChatDetailTableViewCell
        ...
        if  indexPath.row == 0{
            ...
            cell?.subjectLabel.text = "回复：" + item.root
        }
